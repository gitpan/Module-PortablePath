# This Makefile is for the Module::PortablePath extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Module/PortablePath.pm]
#     AUTHOR => q[Roger Pettett <rpettett@cpan.org>]
#     LICENSE => q[perl]
#     NAME => q[Module::PortablePath]
#     PREREQ_PM => { Config::IniFiles=>q[2.38] }
#     VERSION_FROM => q[lib/Module/PortablePath.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Module::PortablePath
NAME_SYM = Module_PortablePath
VERSION = 0.06
...
MAKE = make
FULLEXT = Module/PortablePath
BASEEXT = PortablePath
PARENT_NAME = Module
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Module/PortablePath.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Module/PortablePath.pm
...
TO_INST_PM = lib/Module/PortablePath.pm

PM_TO_BLIB = lib/Module/PortablePath.pm \
...
DISTNAME = Module-PortablePath
DISTVNAME = Module-PortablePath-0.06
...
manifypods : pure_all  \
	lib/Module/PortablePath.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Module/PortablePath.pm $(INST_MAN3DIR)/Module::PortablePath.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Module-PortablePath' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.06' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl extension follow modules to exist in' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Roger Pettett <rpettett@cpan.org>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension follow modules to exist in</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Roger Pettett &lt;rpettett@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Config-IniFiles" VERSION="2,38,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Module/PortablePath.pm blib/lib/Module/PortablePath.pm 
